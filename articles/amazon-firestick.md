...
In addition, newer Firesticks, including the Firestick Select series, use a new OS called VegaOS. OptiSigns is not compatible with VegaOS at all and ***cannot be used***.
...
* **VegaOS devices - Not supported. Will literally not run OptiSigns at all.**
